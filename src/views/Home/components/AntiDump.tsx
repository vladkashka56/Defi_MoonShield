            ...
            <div className="col-lg-6 order-lg-1">
              <div className="p-5">
                <img
                  ...
                  src="assets/img/no-whales-1.svg"
                  alt=""
                ></img>
              </div>
            </div>
            ...
            >
              <div className="p-5">
                ...
                <p className="tx-bg-fx">
                  Buys or sells of more than&nbsp;0.05% of the total supply will
                  be rejected. Whales who make a transfer (between 2 wallets)
                  that is larger than 0.05% of the total supply will be charged
                  2 BNB.
                </p>
              </div>
            </div>
