...
const Header: React.FC = () => {
  ...
  useEffect(() => {
    const fetchBurnAmount = async () => {
      try {
        const balance = await moonShieldFinance.getBurnAmount()
        var burnTotal = balance.div(BigNumber.from(1e9))
      ...
      >
        <div className="masthead-content">
          <div className="container">
            <div className="row">
              <div
                className="col d-flex flex-column flex-wrap flex-grow-1 align-items-center justify-content-center mb-5"
                style={{ position: 'relative' }}
              >
                <h1
                  className="masthead-subheading mb-0 aos-init aos-animate"
                  data-aos="slide-down"
                ...
                <div className="col-12 col d-flex align-items-center justify-content-center mt-3">
                  <iframe
                    ...
                    width="560"
                    height="315"
                    src="https://www.youtube.com/embed/YkRC8nXgwEI"
            ...
            <div
              className="row d-flex align-items-center justify-content-center mb-5 flex-wrap"
              id="header-btns"
            >
              <div className="col flex-grow-1">
                <a
                  className="btn btn-primary font-monospace btn-xl rounded-pill btn-border bg-primary carbon-bg-gray"
                  role="button"
                  data-bs-toggle="tooltip"
                  data-bss-tooltip=""
                  href="https://exchange.pancakeswap.finance/#/swap?outputCurrency=0xf565aaf0b8eb813a1c8c956d2c59f1ce27fd2366"
                  title="Buy $MSHLD here"
                >
                  BUY ON PANCAKESWAP
                </a>
              </div>
              ...
              <div className="col font-monospace flex-grow-1">
                <a
                  ...
                  data-bs-toggle="tooltip"
                  data-bss-tooltip=""
                  href="https://poocoin.app/tokens/0xf565aaf0b8eb813a1c8c956d2c59f1ce27fd2366"
                  title="View a live chart here"
                >
                  POOCOIN CHART
                </a>
              </div>
            ...
            <div className="row d-flex align-items-center justify-content-center flex-column">
              ...
              <div className="col d-flex align-items-center justify-content-evenly flex-row flex-wrap mt-5">
                <div className="social-icons">
                  ...
                  <a
                    className="m-2"
                    href="https://www.facebook.com/MoonShieldDefi/"
                  >
                  ...
                  <a
                    className="m-2"
                    href="https://www.instagram.com/moonshieldfinance/"
                  >
                  ...
                  <a
                    className="m-2"
                    href="https://www.reddit.com/r/MoonShieldFinance/"
                  >
