...
const HeroBanner: React.FC = () => {
  ...
  return (
    <StyledHero
      ...
      style={{ width: '100%', paddingTop: 'calc(5rem + 72px)' }}
    >
      <div style={{ width: '100%' }}>
        <div className="row">
          <div className="justify-content-evenly align-items-center flex-wrap flex-row">
            <div className="row">
              ...
              <div
                className="col-lg-2 col-md-6 col-sml-6 justify-content-right"
                style={{ textAlign: 'right' }}
              >
                <a
                  className="btn btn-primary font-monospace btn-md btn-border bg-primary carbon-bg-gray align-items-end justify-content-right"
                  role="button"
                  href="https://docs.moonshield.finance/"
                >
                  Guide
                </a>
              </div>
