      ...
      >
        <DappRow>
          ...
          >
            ...
            <DappInfoContainer
              className="col-lg-4 col-md-12 my-2 my-md-0 dapp-block"
              style={{ width: '100%' }}
            >
            ...
            <DappInfoContainer className="col-lg-4 col-md-12 my-2 my-md-0">
              <div className="dapp-block d-flex flex-column justify-content-evenly align-items-center">
                <div className="row w-75" style={{ marginTop: '-5%' }}>
                  <div className="col">
                    <StyledIcon
                      src="assets/img/total_bnb_in_liquidity_pool.svg"
                      className="dapp-img"
                      style={{ width: 'auto' }}
                    />
                  </div>
            ...
            <DappInfoContainer className="col-lg-4 col-md-12 my-2 my-md-0">
              <section className="dapp-block d-flex flex-column justify-content-evenly align-items-center">
                ...
                <div className="row">
                  <div className="col text-center">
                    <h1>
                      <strong>Total</strong>&nbsp;BNB in reward pool
                    </h1>
                  </div>
                </div>
                <div className="row">
                  <div className="col">
                    <p>{BNBinRewardPool.toLocaleString()} BNB</p>
                  </div>
                </div>
              </section>
            </DappInfoContainer>
            <DappInfoContainer
              className="col col-lg-4 col-md-12 my-2 my-md-0"
              style={{ width: '100%' }}
            >
              <section className="dapp-block d-flex flex-column justify-content-evenly align-items-center">
                <div className="row w-75">
                  <div className="col">
                    <StyledIcon
                      src="assets/img/smart_balance.svg"
                      className="dapp-img"
                      style={{ width: 'auto' }}
                    />
                  </div>
